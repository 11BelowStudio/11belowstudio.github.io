  ...
  <div style="margin-bottom: 80px;">
    ...
    <div class="paragraph">
      <div>
        ...
        I have also been employed to develop bespoke video games for Natural England and Manx National Heritage.
      </div>
      ...
      <div style="margin-top: 40px;">I'm <strong>currently looking for a job</strong> - ideally somewhere in the field of software development. You can reach me <!--at <a href="mailto:johnmatrix@deltaforce.us">johnmatrix@deltaforce.us</a> or --><router-link to="/contact">through here</router-link>.</div>
    </div>

    <div class="photo">
      <img :src="`/img/avatar.png`" alt="11BelowStudio logo" /> 
    </div>
