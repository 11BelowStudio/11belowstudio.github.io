  ...
  <div>
    ...
    -->
      ...
      <li>
        ...
        <a href="https://github.com/11BelowStudio" target="_blank">github.com/11BelowStudio</a>
      </li>
      <li>
        <i class="fa fa-gamepad fa-lg fa-fw"></i>
        <a href="https://11BelowStudio.itch.io" target="_blank">11BelowStudio.itch.io</a>
      </li>
      <!--
      <li>
